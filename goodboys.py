...
def linex():
	os.system('echo  "\n ======================================\n" | lolcat -a -d 2 -s 50')
def logo():
	os.system('echo "\n <img src='https://images.app.goo.gl/aJxvVrdxwsv14Q7H6" \n    ╔═════════════════════════════╗\n    ║ TOOL NAME: { GOODBOYS }        ║\n    ║ AUTHOR   : MR. CHINDA        ║\n    ║ GITHUB   : github.com/GoodBoyC     ║\n    ╚═════════════════════════════╝" | lolcat -a -d 2 -s 50')	
...
def crack_select1():
	...
	print("\033[92;1m  BRUTE DON START OSHEY 🙌\x1b[0m")
	print("\033[94;1m  THIS IS THE GOODBOYS \033[92;1m✘\033[91;1m✘\x1b[0m")
	linex()
	def main(arg):
		user=arg
		uid,name=user.split("|")
